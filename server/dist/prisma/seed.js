...
async function seedExercises() {
    ...
    const exercises = [
        // ABDOMINAL EXERCISES
        {
            ...
            category: "Compound",
            equipment: "Other",
            instructions: "Hold landmine bar, rotate torso side to side keeping core tight",
        },
        {
            name: "Elbow Plank",
            muscleGroup: "Abdominals",
            category: "Isometric",
            equipment: "Body Only",
            instructions: "Rest on forearms, keep body straight, hold position without sagging hips",
        },
        {
            name: "Bottoms Up",
            muscleGroup: "Abdominals",
            category: "Isolation",
            equipment: "Body Only",
            instructions: "Lie flat, lift legs and hips upward, lower slowly under control",
        },
        {
            ...
            category: "Compound",
            equipment: "Other",
            instructions: "Using suspension straps, extend arms forward, resist core collapse, return to start",
        },
        {
            ...
            category: "Compound",
            equipment: "Dumbbell",
            instructions: "Sit in V-position, hold dumbbells, jab across body alternating sides",
        },
        {
            ...
            category: "Compound",
            equipment: "Cable",
            instructions: "Pull cable diagonally upward across body, rotate torso fully",
        },
        {
            ...
            category: "Compound",
            equipment: "Dumbbell",
            instructions: "Hold dumbbells, swing side to side in controlled arc engaging obliques",
        },
        {
            ...
            category: "Isolation",
            equipment: "Other",
            instructions: "On decline bench, lift hips and knees toward chest, lower slowly",
        },
        {
            name: "Spider Crawl",
            muscleGroup: "Abdominals",
            category: "Compound",
            equipment: "Body Only",
            instructions: "Crawl forward on hands and feet, bring knees toward elbows",
        },
        {
            name: "Cocoons",
            muscleGroup: "Abdominals",
            category: "Isolation",
            equipment: "Body Only",
            instructions: "Lie flat, extend arms overhead, crunch bringing knees and elbows together",
        },
        {
        ...
        },
        {
            ...
            category: "Isolation",
            equipment: "Cable",
            instructions: "Hold cable overhead, bend sideways, return upright under control",
        },
        {
        ...
        },
        {
            ...
            category: "Isolation",
            equipment: "Body Only",
            instructions: "Perform crunch on decline bench, lift shoulders toward knees",
        },
        {
        ...
        },
        {
            ...
            instructions: "Hold dumbbell at side, crunch upward bringing knees toward chest",
        },
        {
            name: "Plate Twist",
            muscleGroup: "Abdominals",
        ...
        },
        {
            ...
            category: "Isolation",
            equipment: "Other",
            instructions: "Hold weight on chest, crunch upward lifting shoulders off floor",
        },
        {
            ...
            category: "Compound",
            equipment: "Barbell",
            instructions: "Roll barbell forward from knees, extend fully, pull back with core",
        },
        {
        ...
        },
        {
            ...
            category: "Isolation",
            equipment: "Body Only",
            instructions: "Hang from bar, raise legs straight up to hip height or higher",
        },
        {
            ...
            category: "Compound",
            equipment: "Barbell",
            instructions: "Roll barbell forward from knees, extend, return with abs engaged",
        },
        {
            name: "Ab Roller",
            muscleGroup: "Abdominals",
            category: "Compound",
            equipment: "Other",
            instructions: "Roll wheel forward from knees, extend, return with controlled core tension",
        },
        {
            name: "Otis-Up",
            muscleGroup: "Abdominals",
        ...
        },
        {
            ...
            category: "Compound",
            equipment: "Body Only",
            instructions: "Lie flat, pedal legs while touching opposite elbow to knee",
        },
        {
            name: "3/4 Sit-Up",
            muscleGroup: "Abdominals",
        ...
        },
        {
            ...
            category: "Isolation",
            equipment: "Body Only",
            instructions: "Lie flat, lift shoulders toward knees keeping lower back on floor",
        },
        {
            ...
            category: "Isolation",
            equipment: "Dumbbell",
            instructions: "Hold dumbbell at side, bend sideways lowering weight, return upright",
        },
        {
        ...
        },
        {
            ...
            category: "Isolation",
            equipment: "Dumbbell",
            instructions: "Sit on incline bench, curl dumbbells with neutral grip, lower slowly",
        },
        {
            ...
            category: "Isolation",
            equipment: "Barbell",
            instructions: "Grip bar wide, curl upward keeping elbows tucked, lower under control",
        },
        {
            ...
            category: "Isolation",
            equipment: "Barbell",
            instructions: "Lie chest-down on incline bench, curl EZ-bar upward, squeeze biceps",
        },
        {
        ...
        },
        {
            ...
            category: "Isolation",
            equipment: "Body Only",
            instructions: "Lie prone, lift leg and draw circles outward engaging hip abductors",
        },
        {
            name: "Hammer Curls",
            muscleGroup: "Biceps",
        ...
        },
        {
            ...
            instructions: "Grip EZ-bar, curl upward keeping elbows close, lower under control",
        },
        {
            name: "Zottman Curl",
            muscleGroup: "Biceps",
        ...
        },
        {
            ...
            category: "Isolation",
            equipment: "Dumbbell",
            instructions: "Sit, brace elbow on thigh, curl dumbbell upward, squeeze biceps",
        },
        {
            ...
            category: "Isolation",
            equipment: "Dumbbell",
            instructions: "Sit on incline bench, curl dumbbells palms up, lower slowly",
        },
        {
            name: "Thigh Adductor",
        ...
        },
        {
            ...
            category: "Isolation",
            equipment: "Machine",
            instructions: "Stand on platform, raise heels upward, lower under control",
        },
        {
        ...
        },
        {
            ...
            category: "Isolation",
            equipment: "Body Only",
            instructions: "Lie on side, bend knees, lift top knee upward keeping feet together",
        },
        {
        ...
        },
        {
            ...
            category: "Isolation",
            equipment: "Machine",
            instructions: "Sit, place weight on thighs, raise heels upward, lower slowly",
        },
        {
        ...
        },
        {
            ...
            category: "Compound",
            equipment: "Other",
            instructions: "Lift handles, walk forward keeping grip strong and posture upright",
        },
        {
            ...
            category: "Isolation",
            equipment: "Barbell",
            instructions: "Rest forearms on bench palms down, curl bar upward with wrists",
        },
        {
        ...
        },
        {
            ...
            category: "Compound",
            equipment: "Barbell",
            instructions: "Lie on floor, barbell on hips, lift hips upward, squeeze glutes",
        },
        {
        ...
        },
        {
            ...
            category: "Isolation",
            equipment: "Barbell",
            instructions: "Rest forearms on bench palms up, curl bar upward with wrists",
        },
        {
        ...
        },
        {
            ...
            category: "Compound",
            equipment: "Dumbbell",
            instructions: "Hold dumbbells, hinge at hips lowering to mid-shin, return upright",
        },
        {
            name: "Clean Deadlift",
            muscleGroup: "Hamstrings",
        ...
        },
        {
            ...
            category: "Isolation",
            equipment: "Barbell",
            instructions: "Sit, hold barbell, extend fingers, curl bar back into grip",
        },
        {
            ...
            category: "Compound",
            equipment: "Dumbbell",
            instructions: "Lie on bench, press dumbbells upward, lower slowly to chest",
        },
        {
            ...
            category: "Compound",
            equipment: "Barbell",
            instructions: "Stand on platform, hinge hips lowering bar deeper, return upright",
        },
        {
            name: "Power Snatch",
            muscleGroup: "Hamstrings",
        ...
        },
        {
            ...
            category: "Isolation",
            equipment: "Dumbbell",
            instructions: "Lie on bench, open arms wide, bring dumbbells together overhead",
        },
        {
            ...
            category: "Compound",
            equipment: "Dumbbell",
            instructions: "Lie on incline bench, press dumbbells upward, lower slowly",
        },
        {
            ...
            category: "Isolation",
            equipment: "Cable",
            instructions: "Pull cables upward from low position crossing hands at chest",
        },
        {
            ...
            category: "Compound",
            equipment: "Body Only",
            instructions: "Anchor feet, lower torso forward, pull back up with hamstrings",
        },
        {
            ...
            category: "Compound",
            equipment: "Machine",
            instructions: "On machine, lower torso forward, pull back up with hamstrings",
        },
        {
            name: "Wrist Roller",
            muscleGroup: "Forearms",
        ...
        },
        {
            ...
            category: "Isolation",
            equipment: "Dumbbell",
            instructions: "Lie on decline bench, open arms wide, bring dumbbells together",
        },
        {
        ...
        },
        {
            ...
            category: "Isolation",
            equipment: "Body Only",
            instructions: "Perform push-up variation spreading arms wide, squeeze chest",
        },
        {
        ...
        },
        {
            ...
            category: "Isolation",
            equipment: "Cable",
            instructions: "Attach cable to ankle, extend leg backward squeezing glutes",
        },
        {
        ...
        },
        {
            ...
            category: "Compound",
            equipment: "Dumbbell",
            instructions: "Hold dumbbells, hinge hips lowering to mid-shin, return upright",
        },
        {
        ...
        },
        {
            ...
            category: "Compound",
            equipment: "Other",
            instructions: "Hang from bar with added weight, pull chin above bar, lower slowly",
        },
        {
        ...
        },
        {
            ...
            category: "Compound",
            equipment: "Other",
            instructions: "Lift stone from ground, cradle to chest, extend hips to stand tall",
        },
        {
            ...
            category: "Compound",
            equipment: "Barbell",
            instructions: "Stand on platform, grip bar, lift with straight back, extend hips fully",
        },
        {
        ...
        },
        {
            ...
            category: "Compound",
            equipment: "Other",
            instructions: "Perform explosive pull-ups or pulldowns alternating grip styles",
        },
        {
        ...
        },
        {
            ...
            category: "Compound",
            equipment: "Body Only",
            instructions: "Pull up explosively, transition over bar, press to lockout",
        },
        {
        ...
        },
        {
            ...
            category: "Compound",
            equipment: "Barbell",
            instructions: "Attach bands to bar, lift with resistance increasing at top",
        },
        {
        ...
        },
        {
            ...
            category: "Compound",
            equipment: "Barbell",
            instructions: "Attach chains to bar, lift with resistance increasing at top",
        },
        {
        ...
        },
        {
            ...
            instructions: "In plank, row kettlebell alternately while stabilizing core",
        },
        {
        ...
        },
        {
            ...
            category: "Compound",
            equipment: "Machine",
            instructions: "Sit on machine, press platform upward with one leg, lower slowly",
        },
        {
            ...
            category: "Isolation",
            equipment: "Dumbbell",
            instructions: "Raise dumbbells forward to shoulder height, then out to sides, lower slowly",
        },
        {
        ...
        },
        {
            ...
            category: "Compound",
            equipment: "Barbell",
            instructions: "Clean bar to shoulders, press overhead, lower under control",
        },
        {
            name: "Triceps Dip",
            muscleGroup: "Triceps",
        ...
        },
        {
            ...
            category: "Compound",
            equipment: "Barbell",
            instructions: "Stand with barbell, squat deeply, drive upward to standing",
        },
        {
        ...
        },
        {
            ...
            category: "Isolation",
            equipment: "E-Z Curl Bar",
            instructions: "Lie on decline bench, lower bar to forehead, extend elbows upward",
        },
        {
            ...
            category: "Compound",
            equipment: "Dumbbell",
            instructions: "Lie on floor, press dumbbells upward, lower elbows to floor",
        },
        {
            name: "Jumping Rope",
            muscleGroup: "Quadriceps",
        ...
        },
        {
            ...
            category: "Compound",
            equipment: "Barbell",
            instructions: "Stand with barbell high on back, squat deeply, drive upward",
        },
        {
        ...
        },
        {
            ...
            category: "Isolation",
            equipment: "Dumbbell",
            instructions: "Raise dumbbells partially to shoulder height, lower under control",
        },
        {
            name: "Leverage Shrug",
            muscleGroup: "Traps",
            category: "Isolation",
            equipment: "Machine",
            instructions: "Grip machine handles, shrug shoulders upward, lower slowly",
        },
        {
        ...
        },
        {
            ...
            category: "Compound",
            equipment: "Body Only",
            instructions: "Place weight on lap, dip down, press upward extending elbows",
        },
        {
            name: "Forward Lunge",
            muscleGroup: "Quadriceps",
        ...
        },
        {
            ...
            category: "Isolation",
            equipment: "Dumbbell",
            instructions: "Lie chest-down on incline, raise dumbbell outward with one arm",
        },
        {
...
async function seedProgrammes() {
    ...
    const compactNorm = (s) => (s || "").toLowerCase().replace(/[^a-z0-9]/g, "");
    const tokenNorm = (s) => (s || "")
        .toLowerCase()
    ...
    const byName = (name) => {
        ...
        found = exercises.find((e) => compactNorm(e.name).includes(targetCompact) ||
    ...
    console.log(`Seeded ${programmes.length} programmes and ${autoGenerate} auto-generated programmes.`);
    if (missingNames.size > 0) {
        console.warn(`Warning: ${missingNames.size} programme exercise names were not found in seeded exercises. Sample missing names:`);
    ...
    if (fuzzyKeys.length > 0) {
        console.info(`Fuzzy matched ${fuzzyKeys.length} programme names to seeded exercises. Sample mappings:`);
        console.info(fuzzyKeys
            .slice(0, 20)
