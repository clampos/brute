...
export const EXERCISE_LIBRARY: ExerciseTemplate[] = [
  ...
  // ── CALVES (additional) ──────────────────────────────────────────────────
  {
    ...
    complementsExercises: ["calves_standing_raise"],
    alternativeFor: [],
    instructions: "Stand on one foot on edge of step, rise onto toes, hold a beat, lower slowly.",
  },
  {
    ...
    defaultSets: 3,
    defaultRepRange: { min: 15, max: 20 },
    complementsExercises: ["calves_standing_raise", "calves_seated_raise"],
    alternativeFor: [],
    instructions: "Feet at bottom of leg press platform, push through toes only, full range of motion.",
  },
  {
    ...
    defaultRepRange: { min: 12, max: 15 },
    complementsExercises: ["calves_standing_raise"],
    alternativeFor: ["calves_standing_raise"],
    instructions: "Hinge forward at hips, load across hips, rise onto toes through full range.",
  },
  {
    id: "calves_db_standing_raise",
    ...
    complementsExercises: ["calves_standing_raise"],
    alternativeFor: ["calves_standing_raise"],
    instructions: "Hold dumbbell in one hand, stand on edge of step, full stretch and rise.",
  },
  ...
  // ── GLUTES (additional) ──────────────────────────────────────────────────
  {
    ...
    complementsExercises: ["glutes_hip_thrust"],
    alternativeFor: [],
    instructions: "Wide stance, toes pointed out, grip inside legs, drive hips through at lockout.",
  },
  {
    ...
    defaultSets: 3,
    defaultRepRange: { min: 15, max: 20 },
    complementsExercises: ["glutes_hip_thrust", "glutes_cable_kickback"],
    alternativeFor: [],
    instructions: "Sit in machine, push knees outward against pads, squeeze glutes at end range.",
  },
  {
    id: "glutes_single_leg_rdl",
    ...
    complementsExercises: ["glutes_hip_thrust"],
    alternativeFor: [],
    instructions: "Balance on one leg, hinge forward with back flat, feel deep glute stretch at bottom.",
  },
  {
    id: "glutes_banded_walk",
    ...
    complementsExercises: ["glutes_hip_thrust"],
    alternativeFor: [],
    instructions: "Band around ankles, slight squat position, step sideways keeping constant tension.",
  },
  {
    id: "glutes_45_deg_hyper",
    ...
    defaultSets: 3,
    defaultRepRange: { min: 12, max: 15 },
    complementsExercises: ["glutes_hip_thrust", "hamstrings_rdl"],
    alternativeFor: [],
    instructions: "Hips on pad, hinge down, drive up squeezing glutes at top, can hold weight.",
  },

  // ── HAMSTRINGS (additional) ──────────────────────────────────────────────
  {
    id: "hamstrings_cable_pull_through",
    ...
    complementsExercises: ["hamstrings_rdl"],
    alternativeFor: ["hamstrings_rdl"],
    instructions: "Face away from cable, hinge at hips pulling rope between legs, squeeze glutes at top.",
  },
  {
    id: "hamstrings_glute_ham_raise",
    ...
    defaultRepRange: { min: 6, max: 10 },
    complementsExercises: ["hamstrings_rdl", "hamstrings_leg_curl"],
    alternativeFor: ["hamstrings_nordic_curl"],
    instructions: "Knees on pad, lower torso using hamstrings as brakes, pull back up explosively.",
  },

  // ── FOREARMS ─────────────────────────────────────────────────────────────
  {
    id: "forearms_barbell_wrist_curl",
    ...
    complementsExercises: [],
    alternativeFor: [],
    instructions: "Forearms on bench, wrists over edge, curl barbell upward, lower with control.",
  },
  {
    ...
    defaultSets: 3,
    defaultRepRange: { min: 15, max: 20 },
    complementsExercises: ["forearms_barbell_wrist_curl"],
    alternativeFor: [],
    instructions: "Forearms on bench, palms facing down, extend wrists upward against resistance.",
  },
  {
    id: "forearms_reverse_curl",
    name: "Reverse Curl",
    muscleGroup: "Forearms",
    movementPattern: "isolation_pull",
    ...
    complementsExercises: ["forearms_barbell_wrist_curl"],
    alternativeFor: [],
    instructions: "Overhand grip, curl to shoulders, targets brachioradialis and forearm extensors.",
  },
  {
    ...
    complementsExercises: [],
    alternativeFor: [],
    instructions: "Hold heavy dumbbells or kettlebells, walk with tall posture, grip as long as possible.",
  },
  {
    ...
    difficulty: "beginner",
    defaultSets: 3,
    defaultRepRange: { min: 20, max: 60 },
    complementsExercises: [],
    alternativeFor: [],
    instructions: "Hang from bar with straight arms, build grip strength and endurance, timed hold.",
  },
  {
    id: "forearms_cable_wrist_curl",
    ...
    defaultRepRange: { min: 15, max: 20 },
    complementsExercises: ["forearms_barbell_wrist_curl"],
    alternativeFor: ["forearms_barbell_wrist_curl"],
    instructions: "Forearms on cable pad, low pulley attachment, curl wrists upward for constant tension.",
  },
  {
    id: "forearms_db_wrist_curl",
    ...
    complementsExercises: [],
    alternativeFor: ["forearms_barbell_wrist_curl"],
    instructions: "Seated, forearms on thighs, curl dumbbells upward at the wrist, squeeze at top.",
  },
];
