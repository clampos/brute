...
INSERT INTO "new_User" ("createdAt", "email", "firstName", "id", "password", "subscribed", "surname", "updatedAt") SELECT "createdAt", "email", "firstName", "id", "password", "subscribed", "surname", "updatedAt" FROM "User";
DROP TABLE "User";
